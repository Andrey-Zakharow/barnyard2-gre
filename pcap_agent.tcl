...
proc CreateRawDataFile { TRANS_ID timestamp srcIP srcPort dstIP dstPort proto rawDataFileName type } {
	...
	set srcIPtoHex [ip::toHex $srcIP] 
	set dstIPtoHex [ip::toHex $dstIP] 
	set srcPortHex [format %4.4X $srcPort] 
	set dstPortHex [format %4.4X $dstPort] 
	set protoHex [format %4.4X $proto] 
	...
	set tcpdumpFilter "proto gre and ((ip\[54:4]=$srcIPtoHex or ip\[58:4]=$dstIPtoHex) and ip\[62:2]=0x$srcPortHex and ip\[64:2]=0x$dstPortHex and ip\[51:1]=0x$protoHex)"
